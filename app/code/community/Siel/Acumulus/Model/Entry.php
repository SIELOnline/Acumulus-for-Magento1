...
class Siel_Acumulus_Model_Entry extends Mage_Core_Model_Abstract {
    ...
    /**
     * Overrides the save() method to clear the created column and set the
     * updated column before being written to the database. The created
     * timestamp is set by the database and should not be set by the
     * application. As MySQl < 5.6.5 only allows one timestamp with a default
     * value, we do set the updated timestamp in code
     ...
     *
     * @return Siel_Acumulus_Model_Resource_Entry_Collection
     */
